...
const capabilities = [
  ...
  ["Behavioral deviation", "Model changes in observable activity instead of assuming silence is benign."],
  ["Evidence-first detection", "Preserve structured evidence, confidence and context for analyst review."],
        ...
        <div className="mx-auto grid max-w-7xl gap-14 px-5 pb-20 pt-20 lg:grid-cols-[1.02fr_.98fr] lg:px-8 lg:pb-28 lg:pt-28">
          <div className="relative flex flex-col justify-center">
            ...
            <div className="mt-10 flex flex-wrap gap-x-7 gap-y-2 font-mono text-[10px] uppercase tracking-[0.16em] text-white/32">
              <span>Open source</span><span>Apache 2.0</span><span>v{siteConfig.version}</span><span>Python / FastAPI</span>
            </div>
          </div>
      ...
      <section className="border-b border-white/6 bg-[#080b0e]">
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
          <div className="grid gap-10 lg:grid-cols-[.75fr_1.25fr]">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#b8ff5a]">The problem</p>
              <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] sm:text-4xl">Silence can be a signal.</h2>
            </div>
            <div className="max-w-3xl space-y-5 text-base leading-8 text-white/55 sm:text-lg">
              <p>Attackers do not need to disappear completely to become harder to see. A C2 channel can quiet. Living-off-the-land activity can taper. A signal can change shape while the underlying operation continues.</p>
              <p>ThreatFade treats a reduction in observability as a measurable behavioral event—then preserves the evidence needed to decide what it means.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-white/6">
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
          <div className="mb-12 max-w-2xl">
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#b8ff5a]">Detection pipeline</p>
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] sm:text-4xl">From fading signal to analyst evidence.</h2>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
          <div className="rounded-2xl border border-white/8 bg-[#090c10] p-8 sm:p-10 lg:flex lg:items-center lg:justify-between lg:p-12">
            <div className="max-w-2xl">
              <div className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.2em] text-[#b8ff5a]"><ShieldCheck className="size-3.5" /> Open source by design</div>

...
export default async function DocPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const structuredData = { "@context": "https://schema.org", "@type": "TechArticle", headline: doc.frontmatter.title, description: doc.frontmatter.description, dateModified: doc.frontmatter.updated, version: docsVersion, url: `${siteConfig.url}/docs/${slug}` };

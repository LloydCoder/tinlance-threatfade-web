export const seoTopics = {
  "behavioral-threat-detection": {
    ...
    description: "How ThreatFade models changes in observable behavior as evidence for analyst review rather than treating reduced activity as automatically benign.",
    status: "validated",
    summary: "ThreatFade's evidence-first thesis focuses on behavioral deviation, structured evidence and analyst review. It does not claim that behavioral change alone proves maliciousness.",
  ...
  "network-threat-hunting": {
    ...
    description: "A practical ThreatFade research path from observable network behavior to evidence-backed analyst investigation.",
    status: "implemented — evidence boundaries apply",
    summary: "ThreatFade provides structured detection evidence, investigation workflow and interoperable outputs; research claims remain bounded by the available validation evidence.",
    links: ["/soc", "/research", "/docs/reference"],
  },
  "detection-engineering": {
    title: "Detection engineering and versioned ThreatFade detection packs",
    description: "How ThreatFade structures detection packs, evidence, ATT&CK mapping and a research-to-production lifecycle.",
    status: "validated",
    summary: "ThreatFade detection packs use stable identifiers and versioning. The intended lifecycle is Research → Backtest → Canary → Production → Deprecated.",
    links: ["/docs/detection-packs", "/research", "/detection"],
  },
  "beaconing-detection": {
    title: "Beaconing and behavioral fade detection",
    description: "How ThreatFade approaches quieting and evasive beacon behavior as temporal behavioral evidence.",
    status: "validated thesis; validation scope applies",
    summary: "ThreatFade is designed around detecting deliberate reductions in observable behavior, with entropy/statistical features and structured evidence feeding analyst review.",
  ...
  "multi-domain-correlation": {
    ...
    description: "How ThreatFade correlates independent network, GNSS and future physical-signal observations without claiming causality.",
    status: "implemented — not production validated",
    summary: "ThreatFade's reusable temporal correlation layer combines canonical observations, explicit time windows, clock-skew tolerance, sensor confidence and uncertainty into evidence-backed observed correlations. The first concrete pack correlates GNSS disruption with network fade/C2 behavior.",

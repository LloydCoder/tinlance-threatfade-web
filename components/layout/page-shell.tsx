...
export function PageShell({
  ...
  return (
    <main className="min-h-screen bg-[var(--tf-canvas)] text-[var(--tf-text)]">
      <SiteHeader />
      <header className="relative overflow-hidden border-b border-[var(--tf-line)]">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-20 lg:px-8 lg:pb-24 lg:pt-28">
          <Link
            href="/"
            className="mb-12 inline-flex items-center gap-2 text-xs text-[var(--tf-text-subtle)] transition hover:text-[var(--tf-text)]"
          >
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-[var(--tf-text-muted)] sm:text-lg">
            {description}
          </p>
        </div>
      </header>
      ...
      <footer className="mx-auto flex max-w-7xl flex-col gap-4 border-t border-[var(--tf-line)] px-5 py-10 text-xs text-[var(--tf-text-subtle)] sm:flex-row sm:items-center sm:justify-between lg:px-8">
        ...
        <div className="flex flex-wrap items-center gap-5">
          <a
            href={siteConfig.tinlanceUrl}
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1 transition hover:text-[var(--tf-signal)]"
            aria-label="Tinlance company website"
          >
            Tinlance <ArrowUpRight className="size-3" />
          </a>
          <a
            ...
            rel="noreferrer"
            className="inline-flex items-center gap-1 transition hover:text-[var(--tf-signal)]"
            aria-label="ThreatFade GitHub repository"
          >

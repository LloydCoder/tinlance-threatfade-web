  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/8 bg-[#090c10] p-4 shadow-2xl shadow-black/30 sm:p-6">
      ...
      <svg
        ...
        role="img"
        aria-label="Illustration of a network signal fading into a detected behavioral deviation"
      >
        <defs>
        ...
        <path
          d="M0 155 C70 118 115 191 180 145 S300 105 360 150 S465 194 520 142 S590 108 630 145"
          fill="none"
          stroke="#b8ff5a"
          strokeWidth="3"
          opacity="0.85"
        ...
        <path
          ...
          d="M630 145 C660 145 670 146 688 154 C708 163 713 181 730 205 C748 231 774 240 800 236 C838 230 855 194 900 210"
          fill="none"
        ...
        <line
          ...
          opacity="0.45"
        />
        <text x="648" y="100" fill="#8b949e" fontSize="14" fontFamily="monospace">
          signal reduction
        </text>
        <text x="745" y="288" fill="#ff8585" fontSize="14" fontFamily="monospace">
      ...
      <div className="relative grid grid-cols-3 gap-3 border-t border-white/7 pt-4 font-mono text-[10px] uppercase tracking-wider">
        <div>
          <div className="text-white/35">State</div>
          <div className="mt-1 text-white/75">Baseline → fade</div>
        </div>
        <div>
          <div className="text-white/35">Evidence</div>
          <div className="mt-1 text-white/75">Preserved</div>
        </div>
        <div>
          <div className="text-white/35">Disposition</div>
          <div className="mt-1 text-[#b8ff5a]">Investigate</div>
        </div>
      </div>
    </div>
  );

...
describe("authenticated platform security", () => {
  it("allows only same-origin callback URLs", () => {
    ...
    expect(safeCallbackUrl("https://app.example/account", "https://app.example")).toBe(
      "https://app.example/account",
    );
    expect(safeCallbackUrl("https://evil.example/steal", "https://app.example")).toBe(
      "https://app.example/soc",
    );
    expect(safeCallbackUrl("//evil.example/steal", "https://app.example")).toBe(
      "https://app.example/soc",
    );
  });

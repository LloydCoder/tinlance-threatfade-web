...
<Callout title="Documentation scope">This documentation tracks the v0.4.0 engine repository. Repository validation is not represented as independent assurance or a universal detection guarantee.</Callout>

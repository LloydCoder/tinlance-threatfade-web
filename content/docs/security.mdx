...
<Callout tone="security" title="Security reporting">Use the repository's security policy and disclosure process for reporting vulnerabilities. Do not publish sensitive exploit details in ordinary documentation issues.</Callout>

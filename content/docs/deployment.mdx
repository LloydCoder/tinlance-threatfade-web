...
<Callout tone="security" title="Secrets">
  Do not place production credentials in Compose files, documentation, source control or
  browser-exposed configuration. Use the organization's secret-management boundary.
</Callout>

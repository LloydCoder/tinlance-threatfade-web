...
<Callout tone="security" title="Do not infer undocumented endpoints">This page intentionally documents only service contracts verified from the engine repository. If an endpoint is not represented here, consult the source repository before building against it.</Callout>

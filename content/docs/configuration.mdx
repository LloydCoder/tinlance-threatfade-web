...
<Callout tone="security" title="Identity boundary">
  Register exact redirect URIs, enforce TLS, protect tokens and use PKCE where applicable. Do not
  treat a local-development configuration as a production identity configuration.
</Callout>

...
<Callout title="Evidence boundary">A valid detection pack proves that the repository's rule structure satisfies its validation contract. It does not prove universal detection effectiveness across arbitrary environments.</Callout>

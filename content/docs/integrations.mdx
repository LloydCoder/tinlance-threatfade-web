...
<Callout title="Compatibility boundary">
  "Compatible" output formats do not mean that every downstream SIEM/SOAR deployment will accept
  every field without local mapping. Validate the target connector and schema in your environment.
</Callout>

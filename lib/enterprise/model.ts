...
export const enterpriseCapabilities: EnterpriseCapability[] = [
  {
    ...
    status: "implemented",
    evidence: "NextAuth OIDC provider and engine enterprise session boundary are present in the web application.",
  },
  {
    area: "Identity",
    capability: "SAML SSO",
    status: "on-demand",
    evidence: "No SAML provider is represented in the current dependency or provider configuration.",
  ...
  },
  {
    ...
    status: "implemented",
    evidence: "Existing authenticated organization/member and analyst boundaries are reused by enterprise workflows.",
  },
  {
    area: "Governance",
    capability: "Security/audit event contract",
    status: "documented",
    evidence: "Enterprise governance documentation defines required authentication, authorization, administrative-action and access-event fields.",
  ...
  },
  {
    ...
    status: "implemented",
    evidence: "Existing health/version engine boundary is exposed through the web integration architecture.",
  },
  {
    area: "Interoperability",
    capability: "SIEM/SOAR/webhook/STIX integration contract",
    status: "documented",
    evidence: "Enterprise integration contract defines adapter boundaries and supported output formats without inventing live connectors.",
  ...
  },
  {
    ...
    status: "implemented",
    evidence: "Public enterprise security and procurement center provides architecture, control, evidence-status and contact material.",
  },
  {
    area: "Compliance",
...
export const enterpriseIntegrationContract = [
  { name: "SIEM", boundary: "server-side adapter", formats: ["CEF", "JSON"], status: "contract-defined" },
  { name: "SOAR", boundary: "server-side adapter", formats: ["JSON webhook"], status: "contract-defined" },
  { name: "Webhooks", boundary: "signed outbound event", formats: ["JSON"], status: "contract-defined" },
  { name: "STIX", boundary: "export adapter", formats: ["STIX 2.1"], status: "contract-defined" },
  { name: "Detection export", boundary: "versioned API/export", formats: ["JSON"], status: "contract-defined" },
] as const;
